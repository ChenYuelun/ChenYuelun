...
class LogUtils {
    companion object {
        ...
        fun processTooLong(msg: String): List<String> {
            ...
            result.add(msg.substring(index, msg.length))
            return result
        }
        ...
        fun d(tag: String, array: Array<String>) {
            if (logCanPrint) {
        ...
        fun d(tag: String, array: IntArray) {
            if (logCanPrint) {
                Log.d(tag, Arrays.toString(array))
            }
